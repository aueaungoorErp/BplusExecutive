...
export const optionalConfigObject = {
  title: Language.t('fingerPrint.header'),
  // Android
  imageColor: '#e00606',
  // Android
  ...
  // Android
  cancelText: Language.t('alert.cancel'),
  // Android
...
export const _pressHandler = async () => {
  let result = false;
  await TouchID.authenticate(Language.t('fingerPrint.header'), optionalConfigObject).then(success => {
