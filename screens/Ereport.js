  ...
  return <SafeAreaView style={container1}>
      ...
      setLoading_backG(false);
            ...
            marginTop: 0
                                ...
                                <View>
                                    <TouchableOpacity onPress={() => navigation.navigate('M1')}>
                                        <View style={{
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset17.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset18.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset19.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('M4')}>
                                        <View style={{
                  backgroundColor: Colors.backgroundLoginColorSecondary,
                  flexDirection: 'column',
                  margin: 10,
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset20.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                {/* <Text style={{
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('M5')}>
                                        <View style={{
                  backgroundColor: Colors.backgroundLoginColorSecondary,
                  flexDirection: 'column',
                  margin: 10,
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset21.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('M6')}>
                                        <View style={{
                  backgroundColor: Colors.backgroundLoginColorSecondary,
                  flexDirection: 'column',
                  margin: 10,
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset22.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
