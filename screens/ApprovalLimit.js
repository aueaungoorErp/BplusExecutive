...
const ApprovalLimit = () => {
  ...
  return <SafeAreaView style={container1}>
      ...
      setLoading_backG(false);
                ...
                {!loading_backG ? <>
                        <Image style={topImage} source={require('../images/UI/Asset39.png')} />
            ...
            marginTop: 0
                  ...
                  alignItems: 'center'
                    ...
                    height: 50,
                    width: 50
                  }} resizeMode={'contain'} source={require('../images/UI/Asset37.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
                  ...
                  alignItems: 'center'
                    ...
                    height: 50,
                    width: 50
                  }} resizeMode={'contain'} source={require('../images/UI/Asset38.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
