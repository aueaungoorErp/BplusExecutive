...
const MainScreen = () => {
    ...
    const backAction = () => {
      if (navigation.getState().index == 0) {
        Alert.alert(Language.t('menu.exitProgram'), Language.t('menu.DoexitProgram'), [{
          text: Language.t('alert.confirm'),
          onPress: () => logOutForexitApp()
        }, {
  ...
  const logOut = async () => {
    ...
    await fetch(databaseReducer.Data.urlser + '/DevUsers', {
      ...
      if (json && json.ResponseCode == '635') {
        ...
        Alert.alert(Language.t('alert.errorTitle'));
      }
    }).catch(error => {
  ...
  return <SafeAreaView style={container1}>
      ...
      setLoading_backG(false);
        ...
        {!loading_backG ? <>
            <Image style={topImage} source={require('../images/UI/Asset5.png')} />
            ...
            marginTop: 0
                ...
                <View>
                  <TouchableOpacity onPress={() => navigation.navigate('Ereport')} style={{
                ...
                elevation: 15
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset7.png')} />
                      <View style={{
                    marginLeft: 20
                  }}>
                        <Text style={{
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate('ReportScreen')} style={{
                backgroundColor: Colors.backgroundLoginColorSecondary,
                flexDirection: 'column',
                margin: 10,
                borderRadius: 10,
                ...
                elevation: 15
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset9.png')} />
                      <View style={{
                    marginLeft: 20
                  }}>
                        <Text style={{
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate('OrderScreen')} style={{
                backgroundColor: Colors.backgroundLoginColorSecondary,
                flexDirection: 'column',
                margin: 10,
                borderRadius: 10,
                ...
                elevation: 15
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset11.png')} />
                      <View style={{
                    marginLeft: 20
                  }}>
                        <Text style={{
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate('DailyCalendarScreen')} style={{
                backgroundColor: Colors.backgroundLoginColorSecondary,
                flexDirection: 'column',
                margin: 10,
                borderRadius: 10,
                ...
                elevation: 15
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../images/UI/Asset12.png')} />
                      <View style={{
                    marginLeft: 20
                  }}>
                        <Text style={{
                  ...
                  <TouchableNativeFeedback onPress={() => Alert.alert('', Language.t('menu.alertLogoutMessage'), [{
                text: Language.t('alert.ok'),
                onPress: () => logOut()
              }, {
                text: Language.t('alert.cancel'),
