  ...
  return <SafeAreaView style={container1}>
      ...
      setLoading_backG(false);
            ...
            marginTop: 0
                                ...
                                <View>
                                    <TouchableOpacity onPress={() => navigation.navigate('IncomeBySlmn', {
                nav: 'IncomeBySlmn',
                routeName: 'IncomeBySlmn'
              })}>
                                        <View style={{
                    ...
                    marginLeft: 20
                      ...
                      fontWeight: 'bold'
                                    ...
                                    {/* <TouchableOpacity
                                     ...
                                     <TouchableOpacity
                                        onPress={() => navigation.navigate('ShowPos', { nav: 'ShowPos', routeName: 'PosByYearMonth' })}
                                             >
                                        <View
                                           style={{
                                            backgroundColor: Colors.backgroundLoginColorSecondary,
