...
const AP_PurcAmount = ({
      ...
      if (responseData.RECORD_COUNT > 0) {
        for (var i in responseData.SHOWPURCHASEVALUESBYAPKEY) {
          let jsonObj = {
            ...
            purcAmount: responseData.SHOWPURCHASEVALUESBYAPKEY[i].SHOWPURCAMOUNT
          };
  ...
  const setRadio_menu1 = (index, val) => {
    ...
    setRadioIndex2(2, null);
    setRadioIndex3(2, null);
  };
