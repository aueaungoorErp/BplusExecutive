...
const AP_ShowArdetail = ({
  ...
  const fetchInCome = async tempGuid => {
    ...
    await fetch(databaseReducer.Data.urlser + '/Executive', {
      ...
      body: JSON.stringify({
        ...
        'BPAPUS-PARAM': '{ "TO_DATE": "' + eDate + '","AP_KEY": ' + route.params.Obj + '}',
        'BPAPUS-FILTER': '',
        'BPAPUS-ORDERBY': '',
        'BPAPUS-OFFSET': '0',
        'BPAPUS-FETCH': '0'
      ...
      if (responseData.RECORD_COUNT > 0) {
        for (var i in responseData.SHOWAPBALANCEBYAPKEY) {
          let jsonObj = {
            ...
            sumpayment: responseData.SHOWAPBALANCEBYAPKEY[i].SHOWSUMPAYMENT
          };
  ...
  return <>
        ...
        flex: 1
                    ...
                    color: Colors.fontColor2,
                    alignSelf: 'center'
                  }}>{Language.t('report.document')}</Text></View>
                                    <View width={deviceWidth * 0.4} style={tableStyles.tableHeaderTitle}><Text style={{
                    fontSize: FontSize.medium,
                    color: Colors.fontColor2,
                    alignSelf: 'center'
                  }}>{Language.t('report.debt')} </Text></View>
                                    <View width={deviceWidth * 0.4} style={tableStyles.tableHeaderTitle}><Text style={{
                    fontSize: FontSize.medium,
                    color: Colors.fontColor2,
                    alignSelf: 'center'
                  }}>{Language.t('report.paid')} </Text></View>
                                    <View width={deviceWidth * 0.4} style={tableStyles.tableHeaderTitle}><Text style={{
                    fontSize: FontSize.medium,
                    color: Colors.fontColor2,
                    alignSelf: 'center'
                  }}>{Language.t('report.outstanding')} </Text></View>
