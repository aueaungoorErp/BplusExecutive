...
const ShowAP = ({
  ...
  return <>
          ...
          marginBottom: 10
            ...
            padding: 10,
            fontSize: FontSize.medium
          }} placeholderTextColor={Colors.fontColorSecondary} value={textsearch} placeholder={'ชื่อเจ้าหนี้'} onChangeText={val => {
            setSearch(val);
          }} />
            ...
            padding: 10
              ...
              width: FontSize.large,
              height: FontSize.large
            }} resizeMode="contain" source={require('../../../img/iconsMenu/search.png')} />
                        </TouchableOpacity>
