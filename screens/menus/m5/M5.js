                    ...
                    < >
                        ...
                        <ScrollView>
                            <View style={{ padding: 20, marginTop: 0 }}>
                                <View>
                                    <TouchableOpacity
                                        onPress={() => navigation.navigate('ShowAR', { nav: 'ShowAR', routeName: 'ArDueDate' })}
                                      >
                                        <View
                                          style={{
                                    ...
                                    <TouchableOpacity
                                        onPress={() => navigation.navigate('Arcat', { nav: 'Arcat', routeName: 'Arcat' })}
                                             >
                                        <View
                                           style={{
                                            backgroundColor: Colors.backgroundLoginColorSecondary,
                                    ...
                                    <TouchableOpacity
                                        onPress={() => navigation.navigate('ShowAP', { nav: 'ShowAP', routeName: 'ApDueDate' })}
                                             >
                                        <View
                                           style={{
                                            backgroundColor: Colors.backgroundLoginColorSecondary,
                                    ...
                                    <TouchableOpacity
                                        onPress={() => navigation.navigate('Apcat', { nav: 'Apcat', routeName: 'Apcat' })}
                                             >
                                        <View
                                           style={{
                                            backgroundColor: Colors.backgroundLoginColorSecondary,
