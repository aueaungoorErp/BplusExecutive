                  ...
                  alignItems: 'center'
                    ...
                    marginLeft: 20
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('Arcat', {
                nav: 'Arcat',
                routeName: 'Arcat'
              })}>
                                        <View style={{
                  ...
                  alignItems: 'center'
                    ...
                    marginLeft: 20
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('ShowAP', {
                nav: 'ShowAP',
                routeName: 'ApDueDate'
              })}>
                                        <View style={{
                  ...
                  alignItems: 'center'
                    ...
                    marginLeft: 20
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('Apcat', {
                nav: 'Apcat',
                routeName: 'Apcat'
              })}>
                                        <View style={{
