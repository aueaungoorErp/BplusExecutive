...
const ChequeBook = ({
  ...
  useEffect(() => {
    ...
    for (var i in arrayObj) {
      newsum += Number(arrayObj[i].sumcqbkamt);
    }
    setSum(newsum);
  }, [arrayObj]);
  ...
  const fetchInCome = async tempGuid => {
    ...
    await fetch(databaseReducer.Data.urlser + '/Executive', {
      ...
      body: JSON.stringify({
        ...
        'BPAPUS-FUNCTION': 'SHOWESTCASHOUTBYCHEQUEOUTDATE',
      ...
      if (responseData.RECORD_COUNT > 0) {
        for (var i in responseData.SHOWESTCASHOUTBYCHEQUEOUTDATE) {
          let jsonObj = {
            id: i,
            year: responseData.SHOWESTCASHOUTBYCHEQUEOUTDATE[i].SHOWYEAR,
            month: responseData.SHOWESTCASHOUTBYCHEQUEOUTDATE[i].SHOWMONTH,
            sumcqbkamt: responseData.SHOWESTCASHOUTBYCHEQUEOUTDATE[i].SUMCQBKAMT
          };
            ...
            color: 'black'
              ...
              height: FontSize.large
                ...
                <View>
                    ...
                    color: Colors.fontColor2,
                    alignSelf: 'center'
                  }}>{Language.t('report.chequeAmount')} </Text></View>
                        ...
                        return <>
                                ...
                                color: Colors.fontColor,
                                alignSelf: 'flex-end'
                              }}>{safe_Format.currencyFormat(item.sumcqbkamt)}</Text></View>
                                                            </View>
                                                        </>;
                      })}
                                            </View>
