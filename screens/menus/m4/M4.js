  ...
  return <SafeAreaView style={container1}>
      ...
      setLoading_backG(false);
            ...
            marginTop: 0
                                ...
                                <View>
                                    <TouchableOpacity onPress={() => navigation.navigate('ChequeIn', {
                nav: 'ChequeIn',
                routeName: 'ChequeIn'
              })}>
                                        <View style={{
                  ...
                  alignItems: 'center'
                    ...
                    marginLeft: 20
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('ChequeBook', {
                nav: 'ChequeBook',
                routeName: 'ChequeBook'
              })}>
                                        <View style={{
                  backgroundColor: Colors.backgroundLoginColorSecondary,
                  flexDirection: 'column',
                    ...
                    marginLeft: 20
                      ...
                      fontWeight: 'bold'
                                    ...
                                    {/* <TouchableOpacity
                                     ...
                                     <TouchableOpacity
                                        onPress={() => navigation.navigate('SkuBalanceByWL', { nav: 'SkuBalanceByWL', routeName: 'SkuBalanceByWL' })}
                                             >
                                        <View
                                           style={{
                                            backgroundColor: Colors.backgroundLoginColorSecondary,
