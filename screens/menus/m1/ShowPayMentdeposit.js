...
const ShowPayMentdeposit = ({
  ...
  useEffect(() => {
    ...
    for (var i in arrayObj) {
      newsum += Number(arrayObj[i].arreceipt);
    }
    setSum(newsum);
  }, [arrayObj]);
  ...
  const fetchInCome = async tempGuid => {
    ...
    await fetch(databaseReducer.Data.urlser + '/Executive', {
      ...
      body: JSON.stringify({
        ...
        'BPAPUS-FUNCTION': 'SHOWPAYMENTDEPOSITBYYEARMONTH',
  ...
  return <>
        ...
        flex: 1
                    ...
                    color: Colors.fontColor2,
                    alignSelf: 'center'
                  }}>{Language.t('report.payment')}</Text></View>
                                    <View width={deviceWidth * 0.4} style={tableStyles.tableHeaderTitle}><Text style={{
                    fontSize: FontSize.medium,
                    color: Colors.fontColor2,
                    alignSelf: 'center'
                    ...
                    alignSelf: 'center'
                        ...
                        return <>
                                ...
                                color: Colors.fontColor,
                                alignSelf: 'flex-end'
                              }}>{safe_Format.currencyFormat(item.arreceipt)}</Text></View>
                                                                <View width={deviceWidth * 0.4} style={tableStyles.tableCellTitle}><Text style={{
                                fontSize: FontSize.medium,
                                color: Colors.fontColor,
                                alignSelf: 'flex-end'
                              }}>{safe_Format.currencyFormat(item.appayment)}</Text></View>
                                                                <View width={deviceWidth * 0.4} style={tableStyles.tableCellTitle}><Text style={{
                                fontSize: FontSize.medium,
                                color: Colors.fontColor,
                                alignSelf: 'flex-end'
                              }}>{safe_Format.currencyFormat(item.ardeposit)}</Text></View>
                                                                <View width={deviceWidth * 0.4} style={tableStyles.tableCellTitle}><Text style={{
                                fontSize: FontSize.medium,
                                color: Colors.fontColor,
                                alignSelf: 'flex-end'
                              }}>{safe_Format.currencyFormat(item.apdepoit)}</Text></View>
...
export default ShowPayMentdeposit;