...
const M1 = () => {
  ...
  return <SafeAreaView style={container1}>
      ...
      setLoading_backG(false);
                ...
                {!loading_backG ? <>
                        <Image style={topImage} source={require('../../../images/UI/Asset13.png')} />
            ...
            marginTop: 0
                                ...
                                <View>
                                    <TouchableOpacity onPress={() => navigation.navigate('ShowInCome')}>
                                        <View style={{
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../../../images/UI/Asset27.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('ShowInComeTeam')}>
                                        <View style={{
                  backgroundColor: Colors.backgroundLoginColorSecondary,
                  flexDirection: 'column',
                  margin: 10,
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../../../images/UI/Asset28.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('ShowBank')}>
                                        <View style={{
                  backgroundColor: Colors.backgroundLoginColorSecondary,
                  flexDirection: 'column',
                  margin: 10,
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../../../images/UI/Asset29.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('ShowSellBook')}>
                                        <View style={{
                  backgroundColor: Colors.backgroundLoginColorSecondary,
                  flexDirection: 'column',
                  margin: 10,
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../../../images/UI/Asset30.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                {/* <Text style={{
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('ShowPayMentdeposit')}>
                                        <View style={{
                  backgroundColor: Colors.backgroundLoginColorSecondary,
                  flexDirection: 'column',
                  margin: 10,
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../../../images/UI/Asset31.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
                      ...
                      fontWeight: 'bold'
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('CurrentStatus')}>
                                        <View style={{
                  backgroundColor: Colors.backgroundLoginColorSecondary,
                  flexDirection: 'column',
                  margin: 10,
                  ...
                  alignItems: 'center'
                    ...
                    height: 40,
                    width: 40
                  }} resizeMode={'contain'} source={require('../../../images/UI/Asset32.png')} />
                                            <View style={{
                    marginLeft: 20
                  }}>
                                                <Text style={{
