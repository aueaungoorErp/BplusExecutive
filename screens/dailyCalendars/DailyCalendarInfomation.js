              ...
              marginTop: 0
                  ...
                  <View style={styles.table}>
                    ...
                    <ScrollView>
                      {/* นัดรับ */}
                      <>
                        {route.params.poppoint && route.params.poppoint.map(item => {
                      return <>
                            ...
                            width: deviceWidth * 0.4
                              ...
                              fontWeight: 'bold'
                                      ...
                                      {' '}
                                      {safe_Format.dateFormat(item.TRH_SHIP_DATE)}
                                    </Text>
                                  </View>
                                  <View style={{
                            width: deviceWidth * 0.5
                            ...
                            width: deviceWidth * 0.3
                              ...
                              fontWeight: 'bold'
                                      ...
                                      {safe_Format.dateFormat(item.TRH_CANCEL_DATE)}{' '}
                                    </Text>
                                  </View>
                                  <View style={{
                            width: deviceWidth * 0.3
                              ...
                              fontWeight: 'bold'
                                      ...
                                      {safe_Format.currencyFormat(item.APPO_A_AMT)}{' '}
                                    </Text>
                                  </View>
                                </View>
                              </>;
                      ...
                      {/* นัดส่ง */}
                      <>
                        {route.params.mappoint && route.params.mappoint.map(item => {
                      return <>
                                <View style={styles.tableView}>
                                  <View style={{
                            width: deviceWidth * 0.4
                            ...
                            width: deviceWidth * 0.3
                              ...
                              fontWeight: 'bold'
                                      ...
                                      {safe_Format.currencyFormat(item.AROE_A_AMT)}{' '}
                                    </Text>
                                  </View>
                                </View>
                              </>;
                      ...
                      {/* รับชำระ */}
                      <>
                        {route.params.rarchqDue && route.params.rarchqDue.map(item => {
                      return <>
                                <View style={styles.tableView}>
                                  <View style={{
                            width: deviceWidth * 0.4
                            ...
                            width: deviceWidth * 0.3
                              ...
                              fontWeight: 'bold'
                                      ...
                                      {safe_Format.currencyFormat(item.ARD_A_AMT)}{' '}
                                    </Text>
                                  </View>
                                </View>
                              </>;
                      ...
                      {/* จ่ายชำระ */}
                      <>
                        {route.params.rapDue && route.params.rapDue.map(item => {
                      return <>
                                <View style={styles.tableView}>
                                  <View style={{
                            width: deviceWidth * 0.4
                            ...
                            width: deviceWidth * 0.3
                              ...
                              fontWeight: 'bold'
                                      ...
                                      {safe_Format.currencyFormat(item.APD_A_AMT)}{' '}
                                    </Text>
                                  </View>
                                </View>
                              </>;
